...
public class ComponentController {
	...
	public JsonNode returnComponentsToJSON(@RequestParam String domainUrl, @RequestParam String domainPath) throws Exception {
		String domainName = utility.getClientName(domainUrl);
		domainPath = "/content/" + domainName + utility.getPagePath(domainPath);
		return mapper.convertValue(exportComponentsToJSON.exportToJSON(domainUrl,domainPath),JsonNode.class);
	}
